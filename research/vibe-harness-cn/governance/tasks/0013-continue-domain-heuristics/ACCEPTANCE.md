...
- 新增条目可解析到八类功能主类并保留来源母领域轴；公共 Core 继续宽松
- 既有 226 source、26 derived 和 reference-only 边界无回归；当前扩展后为 256 source、32 derived
...
- TP-01.01 | Verify: 核对验收项: 形成可追溯的争点、规则、事实、反方和证明标准程序 | Gate: 父步骤范围已确认: research-evidence
- TP-01.02 | Verify: 核对验收项: 形成可审计的影响、权利、比例、监督和责任检查 | Gate: 父步骤范围已确认: research-evidence
- TP-01.03 | Verify: 核对验收项: 区分学习过程证据、迁移证据和熟悉感，保留支架与反馈边界 | Gate: 父步骤范围已确认: research-evidence
- TP-01.04 | Verify: 核对验收项: 结论绑定语言变体、语域、标注、上下文和可反驳对比 | Gate: 父步骤范围已确认: research-evidence
- TP-01.05 | Verify: 核对验收项: 区分来源证据、解释推断和反事实假设，不把叙事写成事实数据库 | Gate: 父步骤范围已确认: research-evidence
- TP-01.06 | Verify: 核对验收项: 形成问题—构念—样本—方法—解释的可追溯链 | Gate: 父步骤范围已确认: research-evidence
...
- 既有 226/26 基线与公共 Core 宽松契约保持
- 高影响领域没有被描述为自动执行、专业意见或责任授权
...
- 标题: 法律推理研究
- 验收标准:
  - 形成可追溯的争点、规则、事实、反方和证明标准程序
- Verify: 核对验收项: 形成可追溯的争点、规则、事实、反方和证明标准程序
...
- 标题: 伦理与公共政策研究
- 验收标准:
  - 形成可审计的影响、权利、比例、监督和责任检查
- Verify: 核对验收项: 形成可审计的影响、权利、比例、监督和责任检查
- Gate: 父步骤范围已确认: research-evidence
- 输出物: research/DOMAIN_EVIDENCE_MATRIX.md
...
- 标题: 教育与学习科学研究
- 验收标准:
  - 区分学习过程证据、迁移证据和熟悉感，保留支架与反馈边界
- Verify: 核对验收项: 区分学习过程证据、迁移证据和熟悉感，保留支架与反馈边界
- Gate: 父步骤范围已确认: research-evidence
- 输出物: research/DOMAIN_EVIDENCE_MATRIX.md
...
- 标题: 语言学研究
- 验收标准:
  - 结论绑定语言变体、语域、标注、上下文和可反驳对比
- Verify: 核对验收项: 结论绑定语言变体、语域、标注、上下文和可反驳对比
- Gate: 父步骤范围已确认: research-evidence
- 输出物: research/DOMAIN_EVIDENCE_MATRIX.md
...
- 标题: 历史推理研究
- 验收标准:
  - 区分来源证据、解释推断和反事实假设，不把叙事写成事实数据库
- Verify: 核对验收项: 区分来源证据、解释推断和反事实假设，不把叙事写成事实数据库
- Gate: 父步骤范围已确认: research-evidence
- 输出物: research/DOMAIN_EVIDENCE_MATRIX.md
...
- 标题: 社会科学方法研究
- 验收标准:
  - 形成问题—构念—样本—方法—解释的可追溯链
- Verify: 核对验收项: 形成问题—构念—样本—方法—解释的可追溯链
- Gate: 父步骤范围已确认: research-evidence
- 输出物: research/DOMAIN_EVIDENCE_MATRIX.md
...
- 输出物: governance/tasks/0013-continue-domain-heuristics/REVIEW.md；governance/tasks/0013-continue-domain-heuristics/VERIFICATION_PLAN.json
