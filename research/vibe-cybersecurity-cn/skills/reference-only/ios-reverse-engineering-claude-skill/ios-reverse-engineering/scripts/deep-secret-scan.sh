...
if [[ -n "$REPORT_FILE" ]]; then
  {
    ...
    echo "- Values matching the allowlist (EXAMPLE, your_key, <AWS_ACCESS_KEY_ID>, sk_test via separate pattern, etc.) are downgraded to INFO unless \`--raw\`."
