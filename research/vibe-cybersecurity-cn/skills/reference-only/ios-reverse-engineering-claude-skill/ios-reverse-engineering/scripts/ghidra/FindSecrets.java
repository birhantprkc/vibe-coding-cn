...
public class FindSecrets extends GhidraScript {
    ...
    protected void run() throws Exception {
        ...
        writer.println("- Values matching the allowlist (EXAMPLE, your_key, <AWS_ACCESS_KEY_ID>, sk_test/pk_test) are tagged FP=High and excluded from CRITICAL/HIGH emphasis.");
